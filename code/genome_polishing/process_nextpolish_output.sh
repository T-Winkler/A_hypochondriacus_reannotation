...
cat "$NPPROCESSED"genome.nextpolish.renamed.fa \
	master_thesis/data/NextPolish/output/prefilter_not_in_Nextpolish.fa \
	master_thesis/data/NextPolish/output/header_without_sequence.fa > master_thesis/data/NextPolish/output/combined.fa
