...
SOURCE_DIR=/scratch/twinkle1/Clouse_short_reads
...
mkdir -p /scratch/twinkle1/STAR_mappings/

STAR --runThreadN 8 \
	--runMode alignReads \
	--outSAMtype BAM SortedByCoordinate \
	--genomeDir /scratch/twinkle1/STAR_index \
	--outFileNamePrefix /scratch/twinkle1/STAR_mappings/SRR_"${SLURM_ARRAY_TASK_ID}"_ \
