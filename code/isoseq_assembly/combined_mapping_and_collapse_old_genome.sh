...
INPUT=data/isoseq/isoseq3_pipeline/combined.merged_clustered.hq.fasta
...
CLUSTERREPORT=data/isoseq/isoseq3_pipeline/combined.merged_clustered.cluster_report.csv
